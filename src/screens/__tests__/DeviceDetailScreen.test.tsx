...
describe('DeviceDetailScreen', () => {
  beforeEach(() => {
    useHomeStore.setState({
      ...
      devices: [{ id: 'd1', name: 'Coffee', kind: 'coffee', roomId: 'r1', isOn: false }],
  ...
  it('opens the edit panel when the options button is pressed', () => {
    ...
    const route = { key: 'DeviceDetail', name: 'DeviceDetail', params: { deviceId: 'd1' } } as any;

    const tree = renderer.create(<DeviceDetailScreen navigation={navigation} route={route} />);
