  ...
  ac: [
    {
      ...
      autoOn: true,
      control: 'dial',
      dialTicks: [AC_TEMP_MIN_C, AC_TEMP_MIN_C + 2, AC_TEMP_MIN_C + 4, AC_TEMP_MAX_C - 2, AC_TEMP_MAX_C],
      order: 1,
    },
    {
      id: 'ac-mode',
...
export function getDeviceCapabilities(device: Device, context: CapabilityContext) {
